...
from src.dataset.kyara import KyaraDatasetConfig
...
class SDXLIPAdapterTraining(ModelForTraining, nn.Module):
    ...
    def train_step(self, batch: dict) -> torch.Tensor:
        ...
        with torch.no_grad():
            reference_pixel_values = self.model.preprocess_reference_image(
                reference_image,
...
def main(config: str):
    ...
    trainer.register_train_dataset_class(KyaraDatasetConfig)
